...
* The original package name 'com.ms-empleados' is invalid and this project uses 'com.msempleados' instead.
...
* [Jersey](https://docs.spring.io/spring-boot/docs/3.1.8/reference/htmlsingle/index.html#web.servlet.jersey)
