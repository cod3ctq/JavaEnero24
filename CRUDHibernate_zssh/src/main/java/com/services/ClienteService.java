...
public class ClienteService {
	...
	ClienteDAO dao = null;
	// http://localhost:8090/CRUDHibernate/CRUDHibernate/clientes/mostrar  GET
	...
	//http://ocalhost:8090/CRUDHibernate/CRUDHibernate/clientes/eliminar/12
	@Path("eliminar/{id}")
	@GET
	@Produces({MediaType.APPLICATION_JSON})
	...
	//http://ocalhost:8090/CRUDHibernate/CRUDHibernate/clientes/editar
	@Path("editar")
	@POST
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
