...
@ControllerAdvice
public class GlobalExceptionMandler extends ResponseEntityExceptionHandler{
  ...
  return ResponseEntity.status(status).body(errores);
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		final List<String> errors = new ArrayList<String>(); 
		  ...
		  ApiErrors errores = new ApiErrors("Datos inválidos", errors, HttpStatusCode.valueOf(400), 
				  LocalDateTime.now()); 
		  return ResponseEntity.status(HttpStatusCode.valueOf(400)).body(errores);
	}
