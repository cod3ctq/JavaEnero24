...
public class Ticket {
	...
	public String toString() {
		return "Ticket [folioOperacion=" + folioOperacion + ", direccion=" + direccion + ", tipoOperacion="
				+ tipoOperacion + ", monto=" + monto + ", fecha=" + fecha + ", getFolioOperacion()="
				+ getFolioOperacion() + ", getDireccion()=" + getDireccion() + ", getTipoOperacion()="
				+ getTipoOperacion() + ", getMonto()=" + getMonto() + ", getFecha()=" + getFecha() + ", getClass()="
